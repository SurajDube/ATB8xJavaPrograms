...
public class Lab119_AllFunction {
    public static void main(String[] args) {
        ...
        function_Type3("suraj");    //  3. call function : with parameter and without return type
        System.out.println(function_Type4(10, 5)); //  4. call function :with parameter and with return type
    }
